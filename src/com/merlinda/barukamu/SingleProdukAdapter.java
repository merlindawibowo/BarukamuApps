...
public class SingleProdukAdapter extends BaseAdapter {
	...
	public SingleProdukAdapter(Activity activity, List<Dashboard> dashboards) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		// TODO Auto-generated method stub
		if (convertView == null){
            convertView = inflater.inflate(R.layout.produk_utama_detail, null);
